...
-- ----------------------------
BEGIN;
INSERT INTO `building` (`building_id`, `building_name`, `building_place`, `building_area`, `create_time`, `update_time`) VALUES (2, '1', '1', '1', '2022-01-01', '1');
COMMIT;
...
INSERT INTO `office_consumables` (`office_consumables_id`, `consumable_name`, `purchase_quantity`, `create_time`, `per_price`, `remark`) VALUES (1062, 'Tse Hiu Tung', 161, '2020-09-09', 89.15, 'QLL0p3GGZ8');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `staff` (`staff_id`, `staff_number`, `staff_name`, `gender`, `staff_age`, `staff_role`, `staff_time`, `salary`, `phone`, `staff_address`, `card_number`) VALUES (3, '20230007', '小明', '0', 24, NULL, NULL, 4500, NULL, NULL, NULL);
INSERT INTO `staff` (`staff_id`, `staff_number`, `staff_name`, `gender`, `staff_age`, `staff_role`, `staff_time`, `salary`, `phone`, `staff_address`, `card_number`) VALUES (4, '20230007', '王五', '0', 24, NULL, NULL, 10000, NULL, NULL, NULL);
